...
class TYLStore(object):
    ...
    def set_locked(self, fingerprint):
        """
        :param fingerprint: JSON string with the lock ID and details of who made the lock.
    ...
    def get_lock_state(self):
        """
        :return: The finterprint/JSON string provided by terraform of the current lock, None if there is no lock.
        """
        pass
